...
import com.donny.dendropass.json.*;
...
public class DendroFactory {
    ...
    public static void init() {
        try {
            ...
            InputStream file = DendroFactory.class.getResourceAsStream("/com/donny/dendropass/resources/unifont.ttf");
            Font font = Font.createFont(Font.TRUETYPE_FONT, file).deriveFont(15f);
            ge.registerFont(font);
            file = DendroFactory.class.getResourceAsStream("/com/donny/dendropass/resources/verdana.ttf");
            ...
            JsonItem ui = DendroPass.getResource("ui.json");
            setUI((JsonArray) ui);
